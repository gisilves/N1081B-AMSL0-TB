...
def read_scalers():
    ...
    now = datetime.now()
    print_and_log(now.strftime("%d/%m/%Y %H:%M:%S") + "\tTotal beam triggers: " + str(scaler_2))
    print_and_log(now.strftime("%d/%m/%Y %H:%M:%S") + "\tTotal cal triggers: " + str(scaler_1))
    print_and_log(now.strftime("%d/%m/%Y %H:%M:%S") + "\tTotal cal CT triggers: " + str(scaler_3))
#    print_and_log(now.strftime("%d/%m/%Y %H:%M:%S") + "\tTotal busy: " + str(scaler_3) + "\n")
    print_and_log(now.strftime("%d/%m/%Y %H:%M:%S") + "\tTotal scintillator ANDs: " + str(scaler_0))

def disable_all_triggers():

    now = datetime.now()
    print_and_log(now.strftime("%d/%m/%Y %H:%M:%S") + "\tStopping all triggers ...")
